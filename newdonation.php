...
<body>
    ...
    <form action="" method="post">
        ...
        <input type="submit" name="done" value="Submit Donation">
    </form>
    <?php
        ...
        $coolllection = $mongoClient->communihelp->donations;
        if (isset($_POST['done'])) {
            $dname = $_POST['iname'];
            $ddes = $_POST['des'];
    ...
    // Update the existing document in the collection
        $updateResulttt = $coolllection->updateOne(
        ['_id' => new MongoDB\BSON\ObjectID('65c0773efb4b81a1bc9309ba')],
        ['$push' => ['data' => $data]]
        );

            // Check if update was successful
            if ($updateResulttt->getModifiedCount() > 0) {
